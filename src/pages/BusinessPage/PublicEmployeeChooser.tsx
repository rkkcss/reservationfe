...
const PublicEmployeeChooser = ({
    ...
    useEffect(() => {
        getPublicBusinessEmployees().then((res) => setEmployees(res.data));
    }, []);
                    ...
                    >
                        <div className="relative">
                            <img
                                ...
                                className={`w-16 h-16 rounded-full object-cover border-2 p-0.5 transition-all  group-hover:border-outline-variant`}
                                style={{
                                ...
                                src={
                                    ...
                                    `https://ui-avatars.com/api/?name=${encodeURIComponent(employee.user.fullName)}&background=random`
                                }
                            />
                        </div>
