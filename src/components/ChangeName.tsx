...
const ChangeName = ({ firstName, lastName }: ChangeUserName) => {
    ...
    return (
        <>
            <p className="text-xl font-semibold mb-6">Név módosítás</p>
                ...
                <Form.Item
                    ...
                    rules={[
                        ...
                        },
                        {
                            min: 2,
                            message:
                                "A vezetéknév legalább 2 karakterből álljon.",
                        },
                        {
                            max: 50,
                            message:
                                "A vezetéknév legfeljebb 50 karakterből lehet.",
                        },
                    ]}
                >
                ...
                <Form.Item
                    ...
                    rules={[
                        ...
                        },
                        {
                            min: 2,
                            message:
                                "A keresztnév legalább 2 karakterből álljon.",
                        },
                        {
                            max: 50,
                            message:
                                "A keresztnév legfeljebb 50 karakterből lehet.",
                        },
                    ]}
                >
