...
import { BusinessPageWrap } from "./pages/BusinessPage/BusinessPage";
...
function App() {
    ...
    if (tenantSlug) {
        return (
            <Routes>
                <Route
                    path="/appointment/:modifierToken"
        ...
        <>
            ...
            <Routes>
                ...
                <Route
                    element={
                        <ProtectedRoute
                            allowedRoles={[Authorities.ROLE_USER]}
                        />
                    }
                >
                ...
                <Route
                    element={
                        <ProtectedRoute
                            allowedRoles={[Authorities.ROLE_ADMIN]}
                        />
                    }
                >
